...
'aischool','목요일.', '목요일', '교육 운영부', 
NOW(), 0, IFNULL(MAX(BOARDGROUP+1),1),0,0,1
FROM TBLBOARD;

INSERT INTO TBLBOARD
SELECT IFNULL(MAX(IDX+1), 1),
'aischool','목요일1.', '목요일1', '교육 운영부', 
NOW(), 0, IFNULL(MAX(BOARDGROUP+1),1),0,0,1
FROM TBLBOARD;

INSERT INTO TBLBOARD
SELECT IFNULL(MAX(IDX+1), 1),
'aischool','목요일2.', '목요일2', '교육 운영부', 
NOW(), 0, IFNULL(MAX(BOARDGROUP+1),1),0,0,1
FROM TBLBOARD;

INSERT INTO TBLBOARD
SELECT IFNULL(MAX(IDX+1), 1),
'aischool','목요일3.', '목요일3', '교육 운영부', 
NOW(), 0, IFNULL(MAX(BOARDGROUP+1),1),0,0,1
FROM TBLBOARD;

INSERT INTO TBLBOARD
SELECT IFNULL(MAX(IDX+1), 1),
'aischool','목요일4.', '목요일4', '교육 운영부', 
NOW(), 0, IFNULL(MAX(BOARDGROUP+1),1),0,0,1
FROM TBLBOARD;

INSERT INTO TBLBOARD
SELECT IFNULL(MAX(IDX+1), 1),
'aischool','목요일5.', '목요일5', '교육 운영부', 
NOW(), 0, IFNULL(MAX(BOARDGROUP+1),1),0,0,1
FROM TBLBOARD;

INSERT INTO TBLBOARD
SELECT IFNULL(MAX(IDX+1), 1),
'aischool','목요일6.', '목요일6', '교육 운영부', 
NOW(), 0, IFNULL(MAX(BOARDGROUP+1),1),0,0,1
FROM TBLBOARD;

INSERT INTO TBLBOARD
SELECT IFNULL(MAX(IDX+1), 1),
'aischool','목요일7.', '목요일7', '교육 운영부', 
NOW(), 0, IFNULL(MAX(BOARDGROUP+1),1),0,0,1
FROM TBLBOARD;

INSERT INTO TBLBOARD
SELECT IFNULL(MAX(IDX+1), 1),
'aischool','목요일8.', '목요일8', '교육 운영부', 
NOW(), 0, IFNULL(MAX(BOARDGROUP+1),1),0,0,1
FROM TBLBOARD;

INSERT INTO TBLBOARD
SELECT IFNULL(MAX(IDX+1), 1),
'aischool','목요일9.', '목요일9', '교육 운영부', 
NOW(), 0, IFNULL(MAX(BOARDGROUP+1),1),0,0,1
FROM TBLBOARD;

INSERT INTO TBLBOARD
SELECT IFNULL(MAX(IDX+1), 1),
'aischool','목요일10.', '10목요일', '교육 운영부', 
NOW(), 0, IFNULL(MAX(BOARDGROUP+1),1),0,0,1
FROM TBLBOARD;

INSERT INTO TBLBOARD
SELECT IFNULL(MAX(IDX+1), 1),
'aischool','목요일11.', '목요일11', '교육 운영부', 
NOW(), 0, IFNULL(MAX(BOARDGROUP+1),1),0,0,1
FROM TBLBOARD;

INSERT INTO TBLBOARD
SELECT IFNULL(MAX(IDX+1), 1),
'aischool','목요일12.', '목요일12', '교육 운영부', 
NOW(), 0, IFNULL(MAX(BOARDGROUP+1),1),0,0,1
FROM TBLBOARD;

INSERT INTO TBLBOARD
SELECT IFNULL(MAX(IDX+1), 1),
'aischool','목요일13.', '목요일13', '교육 운영부', 
NOW(), 0, IFNULL(MAX(BOARDGROUP+1),1),0,0,1
FROM TBLBOARD;

INSERT INTO TBLBOARD
SELECT IFNULL(MAX(IDX+1), 1),
'aischool','목요일14.', '14목요일', '교육 운영부', 
NOW(), 0, IFNULL(MAX(BOARDGROUP+1),1),0,0,1
FROM TBLBOARD;

INSERT INTO TBLBOARD
SELECT IFNULL(MAX(IDX+1), 1),
'aischool','15목요일.', '15목요일', '교육 운영부', 
NOW(), 0, IFNULL(MAX(BOARDGROUP+1),1),0,0,1
FROM TBLBOARD;

INSERT INTO TBLBOARD
SELECT IFNULL(MAX(IDX+1), 1),
'aischool','16목요일.', '16목요일', '교육 운영부', 
NOW(), 0, IFNULL(MAX(BOARDGROUP+1),1),0,0,1
FROM TBLBOARD;

INSERT INTO TBLBOARD
SELECT IFNULL(MAX(IDX+1), 1),
'aischool','17목요일.', '17목요일', '교육 운영부', 
NOW(), 0, IFNULL(MAX(BOARDGROUP+1),1),0,0,1
FROM TBLBOARD;
